...
in
{
  ...
  modules = {
    ...
    host.shell.aliases = {
      ...
      ruff-analyzer = "ruff --line-length 120 --select E,F,W,C90,I,N,UP,YTT,ANN,ASYNC,S,BLE,FBT,B,A,COM,C4,DTZ,T10,EM,EXE,FA,ISC,ICN,G,LOG,PIE,T20,PT,Q,RSE,RET,SLF,SLOT,SIM,TID,TC,ARG,PTH,ERA,PD,PGH,PL,TRY,FLY,PERF,FURB,RUF --ignore A003,N818,S104,PIE804,B008";
    };
  };
}
