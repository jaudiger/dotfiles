...
- Is the new code at the right level of abstraction for its location in the project?
...
- Does each changed function, class, or module have a single clear responsibility?
- Are unrelated concerns mixed in the same change (e.g., business logic and presentation formatting)?
- Should any added code live in a different module based on existing project structure?

### 3. API design

- New public functions or methods: are names clear, parameter lists minimal, return types appropriate?
...
- Does the change introduce code that duplicates existing functionality elsewhere in the codebase?
- If similar code exists, should a shared utility be extracted; or is the duplication acceptable at this stage?
...
- Does the change follow existing patterns in the codebase (naming conventions, project structure, error handling style)?
