...
name: code-security
description: >
  Audit source files for security vulnerabilities. Run /code-security to see
  available languages and security domains. Each domain applies a targeted
  checklist to the given targets and produces a structured report.
