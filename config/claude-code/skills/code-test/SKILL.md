...
name: code-test
description: >
  Audit test suites for quality, coverage gaps, and mutation resistance. Run
  /code-test to see available languages and practices. Each practice applies a
  targeted checklist to the given targets and their corresponding tests,
