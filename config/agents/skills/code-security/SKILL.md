...
1. Open [`lang/$0.md`](lang/$0.md) to confirm the domain is valid for this language and load language-specific secure patterns.
2. Open [`domain/$1.md`](domain/$1.md) to load the security domain checklist.
